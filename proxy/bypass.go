...
//
// link-local（169.254.0.0/16、fe80::/10）一律不 bypass，走上游，避免云 metadata
// （如 169.254.169.254、169.254.170.2）被网关直连暴露宿主凭据面。
//
...
func isBypassTarget(target string) bool {
	...
	// link-local 不 bypass（含云 metadata）；仅回环与 RFC1918/ULA 私网直连。
